...
export async function playGame() {
  ...
  document.querySelector('.status-bar__status-title').innerText = 'Next step';
  ...
  if (trapsAmount == 1) {
    document.querySelector(".status-bar").innerHTML = `
                    ...
                    <div class="status-bar__status">
                      ...
                      <div class="status-bar__status-content"><span class="status-bar__status-title">Next step</span>
  ...
  document.querySelector(".bet-panel").innerHTML = `
                  ...
                  <div class="bet-panel__actions">
                    <div class="flex flex-wrap flex-row mobile:flex-col mobile:gap-y-3">
                        ...
                        <div class="input-state-panel base-input">
                          <div class="flex w-full"><button type="button" class="bet-panel__control" disabled="">
                            ...
                            <div class="state amount session-bet-amount flex-1">
                              ...
                              <div class="bet-amount-label">Your bit:</div>
                      ...
                      <div class="basis-1/3 pl-2 mobile:pl-0 mobile:basis-auto mobile:h-[3.25rem]"><button type="button" disabled="" class="app-button btn-waiting big games-blue-bg text-white cursor-not-allowed block h-full w-full"><span>Waiting</span></button>
                      </div>
                    </div>
                  </div>
...
<div class="bet-panel "><div class="bet-panel__actions"><div class="flex flex-wrap flex-row mobile:flex-col mobile:gap-y-3"><div class="basis-2/3"><div class="input-state-panel base-input"><div class="state win-lose w-full win"><div class="round-result-state-animate game-state-animate" id="loseMessage">You won</div></div></div></div><div class="basis-1/3 pl-2 mobile:pl-0 mobile:basis-auto mobile:h-[3.25rem]"><button id="takePrizeButton" type="button" class="app-button big games-orange-bg main-light-text cashout cursor-not-allowed block h-full w-full" disabled=""><span><div><div class="cashout-amount"><span class="font-bold" id="prizeValue">${prepossiblleMaxWin.toFixed(2)}&nbsp;</span><span class="font-normal" id="prizeCurrency" style="margin-left: 0.1rem;">$</span></div><div><span>Take</span></div></div></span></button></div></div></div></div>
`;
    setTimeout(() => {
      ...
      <div class="status-bar">
          <div class="status-bar__status">
            ...
            <div class="status-bar__status-content"><span class="status-bar__status-title">Max.win</span>
          ...
          <div class="select-traps status-bar__select-traps"><button class="select-traps__prev-arrow-btn disabled:opacity-50" type="button" id="prev_preset_btn" onclick="prevPreset()"><svg class="select-traps__arrow-icon select-traps__arrow-icon_prev" viewBox="0 0 13 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="select-traps__content"><span class="select-traps__traps_amount" id="trapsAmount">${trapsAmount}</span><span class="select-traps__title">traps</span></div><button class="select-traps__next-arrow-btn disabled:opacity-50" type="button" id="next_preset_btn" onclick="nextPreset()"><svg class="select-traps__arrow-icon" viewBox="0 0 13 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.92616 20.0002L10.7906 12.082L12.8584 10.0001L10.7906 7.91821L2.92616 0L0.858398 2.0819L8.72287 10.0001L0.858398 17.9183L2.92616 20.0002Z">
                </path>
              </svg></button>
          </div>
          ...
          <div class="bet-panel__actions">
            <div class="flex flex-wrap flex-row mobile:flex-col mobile:gap-y-3">
              ...
              <div class="basis-1/3 pl-2 mobile:pl-0 mobile:basis-auto mobile:h-[3.25rem]">
                <button id="play_btn" type="button" class="app-button big games-blue-bg text-white cursor-pointer block h-full w-full" onclick="playGame()"><span>Play</span>
                </button>
              </div>
            </div>
          </div>

...
async function checkSignal() {
    ...
    const proxyUrl = 'https://cors-anywhere.herokuapp.com/'; // Прокси-сервис
    const apiUrl = 'https://lucky-jet-history.gamedev-atech.cc/public/history/api/history/replay';
    const url = proxyUrl + apiUrl; // Совмещаем прокси-сервис с URL API
...
function fetchDataAndUpdate() {
    const proxyUrl = 'https://cors-anywhere.herokuapp.com/'; // Прокси-сервис
    const apiUrl = 'https://lucky-jet-history.gamedev-atech.cc/public/history/api/history/replay'; // Исходный API URL
    const url = proxyUrl + apiUrl; // Совмещаем прокси-сервис с URL API

...
const Tour = {
    // key → тексты tour_<key>_t / tour_<key>_d в i18n; target — подсвечиваемый элемент
    steps: [
        { key: "welcome", target: null },
        { key: "market", target: "#market-seg" },
        { key: "pair", target: "#view-signal .select-card" },
        { key: "tf", target: "#tf-chips" },
        { key: "cta", target: "#get-signal-btn" },
        { key: "tabs", target: ".tabbar" },
    ...
    showStep() {
        ...
        // Дожидаемся прокрутки/перерисовки, затем меряем
        setTimeout(() => this.place(target), 60);
